            ...
            <div class="col-lg-4 col-md-6 col-sm-8 mx-auto">
               <div v-if="!registerActive" class="card login" v-bind:class="{ error: emptyFields }">
                  ...
                  <form class="form-group">
                     ...
                     <button type="submit" class="btn btn-primary" @click.prevent="doLogin">Login</button>
               ...
               <div v-else class="card register" v-bind:class="{ error: emptyFields }">
                  ...
                  <form class="form-group">
                     ...
                     <input v-model="surname" type="Surname" class="form-control" placeholder="Surname" required>
                     <button type="submit" class="btn btn-primary" @click.prevent="doRegister"></button>
...
export default {
   ...
   methods: {
      ...
      async doRegister() {
         ...
         try {
            const userCredentials = await createUserWithEmailAndPassword(auth, this.emailReg, this.passwordReg)
